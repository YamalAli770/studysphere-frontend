...
export default function EducationModal() {
  ...
  const onSubmit = (values: z.infer<typeof EducationSchema>) => {
    form.reset();
    startTransition(() => {
      createEducationAction(values).then((data) => {
        if (data?.success) {
          router.refresh();
        ...
        <DialogContent>
          ...
          <DialogDescription>
            <p className="text-gray-500">
              Please provide your latest educational information.
            </p>
          </DialogDescription>
          <Separator />
          <Form {...form}>
                    ...
                    <FormItem>
                      ...
                      <FormControl>
                        ...
                        >
                          ...
                          <SelectContent>
                            <SelectItem id="high_school" value="HIGH_SCHOOL">
                              High School
                            </SelectItem>
                            <SelectItem id="bachelor" value="BACHELOR">
                              Bachelor
                            </SelectItem>
                            <SelectItem id="master" value="MASTER">
                              Master
                            </SelectItem>
                            <SelectItem id="phd" value="PHD">
                              PhD
                            </SelectItem>
                          </SelectContent>
                        </Select>
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl>
                        <Input
                          {...field}
                          placeholder="B.E Software Engineering"
                          type="text"
                          disabled={isPending}
                        />
                      </FormControl>
